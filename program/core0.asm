# assembly code for core 0 of modified RISC-V specification (with atomic LOAD and STORE instructions, and PC incremented by one)
...
LW r2, r0, 0x004			# loading a address to start searching from (later incremented)
LW r3, r0, 0x005			# loading a address to stop search at
