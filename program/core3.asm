# assembly code for core 3 of modified RISC-V specification (with atomic LOAD and STORE instructions, and PC incremented by one)
...
LW r2, r0, 0x00A			# loading a address to start searching from (later incremented)
LW r3, r0, 0x00B			# loading a address to stop search at
